<?php
  ...
  $id = $_GET['id_matkul'];
  $result = mysqli_query($conn2, "SELECT * FROM sem1 WHERE id_matkul = $id");
...
<body>
  <div id="main">
    <header>
      ...
      <a id="back" href="sem_admin/s1.php"><img id="back-btn" src="img/back.png"></a>
      <p>Edit Matkul</p>
    </header>
    <form method="post" action="update_matkul1.php">
