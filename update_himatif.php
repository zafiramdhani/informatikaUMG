<?php
  ...
  if (isset($_POST['update'])) {
    if (isset($_FILES['bagan']['tmp_name'])) {
      ...
      mysqli_query($conn, "UPDATE himatif SET foto_bagan='$image', nama_file='$file_name', tipe_file='$file_type', ukuran_file='$file_size' WHERE id='$id' ");
      header("Location: himatif_admin.php");
    }
  }
