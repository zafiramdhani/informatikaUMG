<?php
  ...
  if (isset($_POST['tambah'])) {
    ...
    mysqli_query($conn2, "INSERT INTO sem5 VALUES ('', '$tambahmatkul')");
    ...
    <div id="list-container">
      ...
      ?>
        <div id="list-matkul">
          <?= $matkul['nama_matkul'] ?>
          <div id="menu">
            <?= "<a href='/KULIAH/MOBILEPROGRAMMING3/edit_matkul5.php?id_matkul=$matkul[id_matkul]'><img id='edit' src='/KULIAH/MOBILEPROGRAMMING3/img/edit.png' width='30px'></a>" ?>
            <?= "<a href='/KULIAH/MOBILEPROGRAMMING3/delete_matkul5.php?id_matkul=$matkul[id_matkul]'><img id='hapus' src='/KULIAH/MOBILEPROGRAMMING3/img/delete.png' width='30px'></a>" ?>
          </div>
        </div>
      <?php  
        }
