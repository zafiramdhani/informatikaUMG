<?php
  ...
  $result = mysqli_query($conn, "SELECT * FROM himatif");
  $himatif = mysqli_fetch_array($result);
?>
...
<body>
  <div id="main">
    ...
    <p id="title-bagan">bagan himatif</p>
    <!-- <img id="bagan-himatif" src="img/bgnhimatif.png"> -->
    <?= '<img id="bagan-himatif" src="data:image/png;base64, '.base64_encode($himatif['foto_bagan']).' ">'; ?>
    <form action="update_himatif.php" method="post" enctype="multipart/form-data">
      <div id="bagan-baru">
        <input type="hidden" value="<?php echo $himatif['id'];?>" name="id">
        <label for="bagan">Bagan baru</label>
